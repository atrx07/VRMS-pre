...
public class LoginPage extends JFrame {
    ...
    private JPanel createLoginCard() {
        ...
        gbc.gridy = 0;
        card.add(centeredLabel("CUSTOMER LOGIN", Font.BOLD, 13, Color.BLACK), gbc);

        gbc.gridy++;
        gbc.insets = new Insets(15, 0, 0, 0);
        card.add(centeredLabel("VRMS", Font.BOLD, 18, UIColors.PRIMARY), gbc);

        gbc.gridy++;
        gbc.insets = new Insets(12, 0, 19, 0);
        card.add(centeredLabel("Sign In to Your Account", Font.PLAIN, 18, Color.BLACK), gbc);
    ...
    private void login() {
        ...
        JOptionPane.showMessageDialog(this,
                "Login UI complete. Authentication will be added in a later phase.",
                "VRMS",
