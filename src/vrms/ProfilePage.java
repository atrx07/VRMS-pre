...
public class ProfilePage extends JFrame {
    public ProfilePage() {
        ...
        header.add(UIUtils.label("My Profile", Font.BOLD, 28, UIColors.TEXT_DARK));
        header.add(Box.createVerticalStrut(4));
        header.add(UIUtils.label(
                "Update your personal details used by VRMS",
                Font.PLAIN,
                12,
                UIColors.TEXT_MUTED
        ));
        ...
        JLabel account = UIUtils.label("Customer Account", Font.BOLD, 15, UIColors.PRIMARY);
        ...
        UIUtils.addField(card, "Name", name);
        UIUtils.addField(card, "Email", email);
        UIUtils.addField(card, "Phone", phone);
        UIUtils.addField(card, "New Password", password);
