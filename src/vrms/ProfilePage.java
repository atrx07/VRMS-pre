...
public class ProfilePage extends JFrame {
    public ProfilePage(){
        ...
        JTextField name=new JTextField(); JTextField email=new JTextField(); JTextField phone=new JTextField(); JPasswordField password=new JPasswordField();
        ...
        JButton back=UIUtils.secondaryButton("Back to Catalog"); back.addActionListener(e->UIUtils.showPage(this,new CatalogPage()));
        JButton save=UIUtils.primaryButton("Save Changes"); save.addActionListener(e->UIUtils.previewAction(this,"Save Changes","updates the customer's profile details"));
        actions.add(back); actions.add(save); root.add(actions,BorderLayout.SOUTH);
    }
